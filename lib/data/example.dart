...
// for the different flags
List<Reaction<String>> flagsReactions = [
  Reaction<String>(                                 //uk flag shows
    value: 'en',
  ...
  Reaction<String>(
    value: 'ar',
    previewIcon:
    _builFlagsdPreviewIcon('assets/images/algeria-round.png', 'Arabic'),  //arabic flag
    icon: _buildIcon('assets/images/algeria.png'),
  ),
  Reaction<String>(
    value: 'gr',
    previewIcon:
    _builFlagsdPreviewIcon('assets/images/germany-round.png', 'German'),    //german flag
    icon: _buildIcon('assets/images/germany.png'),
  ),
  Reaction<String>(
    value: 'sp',
    previewIcon:
    _builFlagsdPreviewIcon('assets/images/spain-round.png', 'Spanish'),   // span flag
    icon: _buildIcon('assets/images/spain.png'),
  ),
  Reaction<String>(
    value: 'ch',
    previewIcon:
    _builFlagsdPreviewIcon('assets/images/china-round.png', 'Chinese'),     // china flag
...
final defaultInitialReaction = Reaction<String>(
  value: null,
  icon: Text('Not reacted'),    // if no reaction
);
